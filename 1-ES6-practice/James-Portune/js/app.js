...
function displayPics(){
  ...
  // WHen changing var rando to let rando it becomes a block element and will onlt work in the block of the code so only in the while loop. Since rando is declared and the value of it comes from makeRandom, the variable will not exist to be assigned since it is not in the makeRandom function.
  console.log(viewed)
